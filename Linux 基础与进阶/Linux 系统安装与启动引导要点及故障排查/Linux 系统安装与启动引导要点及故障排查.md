...
- [Linux 系统安装与启动引导及故障排查](#linux-系统安装与启动引导及故障排查)
  - [文档目录](#文档目录)
  - [常见物理服务器远程带外口](#常见物理服务器远程带外口)
  - [不同型号物理服务器安装 Linux 的故障排查](#不同型号物理服务器安装-linux-的故障排查)
  - [RHEL 中 grub 引导配置文件的说明](#rhel-中-grub-引导配置文件的说明)
  - [RHEL 配置开机启动方式](#rhel-配置开机启动方式)
  - [系统开机自启动定义文件](#系统开机自启动定义文件)
  - [多种系统破解 root 密码的方式](#多种系统破解-root-密码的方式)
  - [系统无故关机并重启原因排查方法](#系统无故关机并重启原因排查方法)
  - [案例：DELL R730 物理机 CentOS 7.2 开机启动恢复](#案例dell-r730-物理机-centos-72-开机启动恢复)
  - [创建兼容 UEFI 与 BIOS 引导的 RHEL 6 自动化安装 ISO 镜像](#创建兼容-uefi-与-bios-引导的-rhel-6-自动化安装-iso-镜像)
  - [创建兼容 UEFI 与 BIOS 引导的 CentOS 7 自动化安装 ISO 镜像](#创建兼容-uefi-与-bios-引导的-centos-7-自动化安装-iso-镜像)
  - [🚀 CentOS 7 的 kernel 升级方法](#-centos-7-的-kernel-升级方法)
