...
- [Linux 中使用 AIDE 监控文件系统更改](#linux-中使用-aide-监控文件系统更改)
  - [文档目录](#文档目录)
  - [使用AIDE检测文件系统更改](#使用aide检测文件系统更改)
    - [使用AIDE分析文件系统更改](#使用aide分析文件系统更改)
  - [使用AIDE调查文件系统更改](#使用aide调查文件系统更改)
    - [结合使用AIDE和Audit](#结合使用aide和audit)
    - [配置AIDE和Audit](#配置aide和audit)
    - [调查文件系统更改](#调查文件系统更改)
    - [解读审计事件（audit event）](#解读审计事件audit-event)
