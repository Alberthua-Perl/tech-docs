...
```bash
## root@workstation
$ wget https://rh-course-materials.oss-cn-hangzhou.aliyuncs.com/root-ca.tar
$ wget https://rh-course-materials.oss-cn-hangzhou.aliyuncs.com/inter-ca.tar
#下载根 CA 证书与中间 CA 证书相关文件的 lab 用归档包
$ tar -xf root-ca.tar
$ tar -xf inter-ca.tar
