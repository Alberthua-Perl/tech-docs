...
- [⭕ S2I 基本原理与应用构建部署示例](#-s2i-基本原理与应用构建部署示例)
  - [文档说明](#文档说明)
  - [文档目录](#文档目录)
  - [S2I 基本原理](#s2i-基本原理)
  - [S2I 的使用方式](#s2i-的使用方式)
  - [使用外部自定义 S2I 脚本构建 Apache HTTPD 应用镜像](#使用外部自定义-s2i-脚本构建-apache-httpd-应用镜像)
  - [创建自定义 S2I 构建镜像：Golang 构建镜像](#创建自定义-s2i-构建镜像golang-构建镜像)
  - [创建自定义应用镜像：创建 Golang 应用镜像](#创建自定义应用镜像创建-golang-应用镜像)
  - [🚀 OpenShift 集成构建与部署 Golang 应用](#-openshift-集成构建与部署-golang-应用)
  - [参考链接](#参考链接)
