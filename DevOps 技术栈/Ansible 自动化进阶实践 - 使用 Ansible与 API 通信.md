...
- 使用 REST API：
  ...
  - 如下所示，使用 `Firefox web` 浏览器访问相同的 API：
    ...
    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/tower-apiv2-demo-1.jpg)
    
    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/tower-apiv2-demo-2.jpg)
...
- 使用 API 启动作业模板：
  ...
  - 从 API 启动作业模板分两个步骤完成：
    ...
    - 使用 `POST` 方法访问它以启动该作业。
      ...
      ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/apiv2-post-method-survey-variable.jpg)
...
- Vault 凭据：
  ...
  - 这将使用由 playbook 的任务所引用的工作模板，在 Ansible Tower 服务器上启动一项新作业。
    ...
    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/vault-credential-demo.jpg)
    
    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/job-template-vault-credential.jpg)
    ...
    > 3. 如下所示：
    >    
    >    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/tower-apiv2-job-template-triggle-another-job.jpg)
...
- 基于令牌（token）的身份验证：
  ...
  - [个人访问令牌示例](https://github.com/Alberthua-Perl/ansible-demo/blob/master/do447-course-demo/chapter11/pat-apiv2-uri.yaml)：
    ...
    >    
    >    ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/job-template-not-extra-var-error.jpg)
...
- 与 API 交互：
  ...
  - 🤘 `uri` 模块：
    ...
    - `method` 参数及常见选项：指定连接到服务端所用的 HTTP 方法
      ...
      ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/primary-http-method.jpg)
...
- 处理 API 响应：
  ...
  - 🚀 示例 2：
    ...
    > 
    > ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/create-personal-access-token-demo.jpg)
    ...
    - [示例](https://github.com/Alberthua-Perl/ansible-demo/blob/master/do447-course-demo/chapter11/gitlab-api-v4-connect.yaml)：
      ...
      ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/gitlab-api-v4-connect-demo.jpg)
...
- 使用过滤器准备和解析数据：
  ...
  - `urlencode` 过滤器：
    ...
    - [示例](https://github.com/Alberthua-Perl/ansible-demo/blob/master/do447-course-demo/chapter11/http_restful_api_filter.yaml)：
      ...
      ![](https://github.com/Alberthua-Perl/tech-docs/tree/master/images/ansible-advanced-practice/ansible-api-test/http-restful-api-filter-1.jpg)
