...
> 
> [gitlab-api-v4-connect.yml](https://github.com/Alberthua-Perl/ansible-demo/blob/master/do447-course-demo/gitlab-api-v4-connect.yml)
...
- 与 API 交互：
  ...
  - 🤘 `uri` 模块：
    ...
    - `method` 参数及常见选项：指定连接到服务端所用的 HTTP 方法
      ...
      ![](D:\Linux操作系统与编程语言汇总\Typora文档汇总\CICD\Ansible高级自动化最佳实践\pictures\Chapter03\primary-http-method.jpg)
...
- 处理 API 响应：
  ...
  - 🚀 示例 2：
    ...
    > 
    > ![](D:\Linux操作系统与编程语言汇总\Typora文档汇总\CICD\Ansible高级自动化最佳实践\pictures\Chapter03\create-personal-access-token-demo.jpg)
    ...
    - API 调用返回的 `JSON` 是字典的列表（a list of dictionaries），其中每一字典都包含关于一个用户的信息，username 键包含用户的用户名。
      ...
      ![](D:\Linux操作系统与编程语言汇总\Typora文档汇总\CICD\Ansible高级自动化最佳实践\pictures\Chapter11\gitlab-api-v4-connect-demo.jpg)
